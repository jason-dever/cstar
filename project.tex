...
\begin{definition}
    Given $\mathcal{E} \subseteq E(S)$, we call $Z \subseteq E(S)$ an \textit{outer cover} for $\mathcal{E}$ if
    $\forall e \in \mathcal{E}$, $\exists z \in Z$ with $ez \neq 0$. If is $Z$ an outer cover for $\mathcal{E}$ 
    and $Z \subseteq \mathcal{E}$, we say $Z$ is a \textit{cover} for $\mathcal{E}$.
\end{definition}
