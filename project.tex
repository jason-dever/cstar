...
let $\mathcal{U}(X, Y) = \{\xi \in \hat{E}_0\text{: } X \subseteq \xi \text{ and } Y \cap \xi = \emptyset\}$.
Sets of this form form a basis for the topology on the set of filters. With this topology, the topological
